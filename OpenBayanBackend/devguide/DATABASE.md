...
| Field | Type | Description |
|:---|:---|:---|
| `text` | `string` | Arabic word with Tashkeel |
...
| `meanings` | `object?` | Lexical meanings |
...
| `mentions` | `sentence\|hadith` | `entity` | Named entity link |
| `entity_relation` | `entity` | `entity` | Entity-to-entity relationship |
| `entity_tagged_with` | `entity` | `category` | Entity taxonomy |
| `composed_of` | `sentence` | `word` | Linguistic breakdown |
| `extracted_from` | `faidah` | `sahifah\|ayah` | *(Legacy — see note)* |
